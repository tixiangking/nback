...
matplotlib.rcParams['font.sans-serif'] = ['SimHei']  # 使用 'SimHei' 这个字体支持中文
...
ax1.set_xlabel('网桥数量', color='k', fontsize=30)
label1 = ax1.set_ylabel('补偿前的平均同步误差(\u03bcs)', color='c', fontsize=30)
label1.set_path_effects([PathEffects.withStroke(linewidth=1, foreground='k')])
ax1.tick_params(axis='y', labelcolor='c', labelsize=30)

label2 = ax2.set_ylabel('补偿后的平均同步误差(ns)', color='y', fontsize=30)
label2.set_path_effects([PathEffects.withStroke(linewidth=1, foreground='k')])
